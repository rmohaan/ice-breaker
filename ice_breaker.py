...
def ice_break_with(name: str) -> Tuple[Summary, str]:
    linkedin_url = lookup(name, True)
    linkedin_profile_data = linkedin.scrape_linkedin_profile(linkedin_url, True)
    ...
    return res, linkedin_profile_data.get("profile_pic_url")
